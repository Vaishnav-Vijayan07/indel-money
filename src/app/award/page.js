...
const awards = [
    {
        ...
        discription: "Aliquam malesada risus at nulla egestas, sit amet feugiat tortor molestie. Fusce dapibus tempus eros ac vehicula. Fusce faucibus, justo et cursus varius, metus.",
        year: "2024"
    },
    {
        href: "/",
...
export default function Award() {
    return (
        <>
            ...
            <section className="xl:p-[30px_0_20px_0] 2xl:p-[40px_0_60px_0] border-b border-b-[rgb(0,0,0,18%)] relative z-0 before:content-[''] before:absolute before:top-0 before:bottom-0 before:block before:w-full before:h-full before:bg-gradient-to-r before:from-[rgba(243,0,0,0.00)] before:to-[rgba(235,2,8,0.10)] before:pointer-events-none">
                <div className="container">
