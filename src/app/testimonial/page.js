...
const TESTIMONIAL_DATA = [
    {
        ...
        quote: 'Team Indel Money is like my second home. I feel honored and valued as a member in this environment that holds inclusiveness at its core. My company understands my life roles as a professional and also as a mother. My peers and the company always extend their helping hands whenever I face an emergency situation. The vibrant atmosphere and culture in the office binds everyone together and experience a feeling of togetherness.',
        profileImage: '/api/placeholder/400/400',
        hasVideo: true,
        videoSrc: '/path/to/video' // Add video source if available
    },
    {
        name: 'Sruthy Madhav',
        role: 'Branch Manager',
        quote: 'I manage to contribute to the company and still have time for my family. The management team makes sure that the suggestions and opinions of the employees are valued and included in the planning process of the organisation.',
        profileImage: '/api/placeholder/400/400',
        hasVideo: false
    },
    {
        ...
        role: 'Team Member',
        quote: 'Working here has been an incredible experience. The company culture is supportive and innovative.',
        profileImage: '/api/placeholder/400/400',
        hasVideo: false
    }
];
                ...
                <div className="absolute inset-0 bg-black bg-opacity-10 flex items-center justify-center">
                    <div className="text-center">
                        <img
                            ...
                            className="mx-auto w-36 h-36 rounded-full object-cover border-4 border-blue-50 mb-4"
                        />
        ...
        <div className="bg-white shadow-md rounded-lg overflow-hidden flex flex-col md:flex-row">
            <div className="md:w-1/4 p-6 flex items-center justify-center">
                <img
                    src={testimonial.profileImage}
                    alt={testimonial.name}
                    className="w-36 h-36 rounded-full object-cover border-4 border-blue-50"
                />
            </div>
