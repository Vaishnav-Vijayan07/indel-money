...
export default function Blog() {
  return (
    <>
      ...
      <LatestUpdates />
      <section className="p-[30px_0_20px_0] 2xl:p-[40px_0_60px_0] relative z-0 before:content-[''] before:absolute before:top-0 before:bottom-0 before:block before:w-full before:h-[76%] before:bg-gradient-to-r before:from-[rgba(243,0,0,0.00)] before:to-[rgba(235,2,8,0.10)] before:my-auto before:pointer-events-none">
        <div className="container">
