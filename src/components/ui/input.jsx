...
function Input({
  ...
  return (
    (<input
      ...
      data-slot="input"
      className={cn(
        "text-[13px] sm:text-[12px] lg:text-[12px] 2xl-[14px] 3xl:text-[16px] leading-none font-normal border-input text-black",
        "w-full min-w-0 h-[35px] sm:h-[30px] xl:h-[35px] 2xl:h-[40px] 3xl:h-[48px] flex rounded-md border bg-transparent px-3 py-1",
