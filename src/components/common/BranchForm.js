...
export default function SearchForm() {
    ...
    return (
        <form
            className="bg-white shadow-[0_0_50px_rgba(0,0,0,0.15)] rounded-[22px] 2xl:rounded-[30px] px-[30px] 2xl:px-[50px] py-[20px] 2xl:py-[30px] flex gap-[20px] 2xl:gap-[30px] mb-[30px] 2xl:mb-[35px]"
        >
            {/* State */}
            <div className="basis-1/5">
                <Select className="shadow-none outline-none border-none focus-within:shadow-none focus:shadow-none">
                    <SelectTrigger className="w-[100%] bg-[#E7EFF9] text-[rgba(50,50,50,0.60)] rounded-[7px] 2xl:rounded-[10px] h-[37px] xl:h-[45px] 2xl:h-[48px] shadow-none outline-none border-none cursor-pointer focus-within:shadow-none">
            ...
            <div className="basis-1/5">
                <Select>
                    <SelectTrigger className="w-[100%] bg-[#E7EFF9] text-[rgba(50,50,50,0.60)] rounded-[7px] 2xl:rounded-[10px] h-[37px] xl:h-[45px] 2xl:h-[48px] shadow-none outline-none border-none cursor-pointer">
            ...
            <div className="basis-1/5 flex items-center justify-end">
                <Button type="submit" className="w-full cursor-pointer text-[14px] xl:text-[16px] 2xl:text-[18px] max-w-[195px] bg-[#EE3824] text-white rounded-[100px] h-[37px] xl:h-[45px] 2xl:h-[48px] hover:bg-base1 transition-all">SEARCH</Button>
            </div>
        </form>
    );
}
