...
export default function BlogCard({ item, className }) {
    return (
        <Link href={item?.href} className={`${className} group w-full h-full flex py-[5px] xl:py-[10px] 2xl:py-[15px] gap[10px] xl:gap-[15px] 2xl:gap-[30px]`}>
            ...
            <div className="w-[calc(100%-276px)] 2xl:w-[calc(100%-320px)] py-2">
                <div className="text-sm 2xl:text-[16px] text-[#505050] line-clamp-1 mb-0.5 2xl:mb-1 transition-transform duration-300 group-hover:text-base2">{item?.date}</div>
