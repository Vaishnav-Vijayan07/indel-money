...
export default function BlogCard({ item, className }) {
    return (
        <Link href={item?.href} className={`${className ? className : ""} group w-full h-full flex py-[5px] xl:py-[10px] 3xl:py-[15px] gap-[10px] xl:gap-[20px] 2xl:gap-[25px] 3xl:gap-[30px]`}>
            <div className="group w-[160px] lg:w-[180px] xl:w-[220px] 2xl:w-[240px] 3xl:w-[320px] overflow-hidden rounded-[20px] relative z-0">
                <Image
                    src={item?.image}
                    alt={item?.alt}
                    fill
            ...
            <div className="w-[calc(100%-160px)] lg:w-[calc(100%-180px)] xl:w-[calc(100%-220px)] 2xl:w-[calc(100%-240px)] 3xl:w-[calc(100%-320px)] py-1 3xl:py-2">
                {item?.date &&
