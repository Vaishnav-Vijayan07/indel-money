...
export default function BranchLocationMap() {
  ...
  return (
    <div className="flex w-full h-[510px] 2xl:h-[670px] relative z-[1] rounded-2xl overflow-hidden">
      <div className="w-[calc(100%-220px)] lg:w-[calc(100%-260px)] xl:w-[calc(100%-320px)] 2xl:w-[calc(100%-420px)] relative z-0">
        <MapContainer
          center={mapCenter}
          zoom={12}
      ...
      <div className="w-[220px] lg:w-[260px] xl:w-[320px] 2xl:w-[420px] bg-[#17479E]">
        <h2 className="text-[16px] lg:text-[18px] 2xl:text-[22px] text-white font-bold p-[5px_10px] lg:p-[10px_15px] 2xl:p-[15px_30px] border-[1px] border-solid border-white/80">
        ...
        <div className="overflow-y-auto max-h-[calc(100%-65px)]">
          {branchLocations.map((branch) => (
            <div
              key={branch.id}
              className={`p-[10px_10px] lg:p-[20px_15px] 2xl:p-[20px_30px] cursor-pointer border-b-[1px] border-solid border-white/10 loclist ${
            ...
            >
              ...
              {/* <div className="flex items-center mb-[15px] flex-wrap">
                ...
                <span className="w-[calc(100%-16px)] pl-[10px] text-[16px] font-normal text-white">
                  {branch.phone}
                </span>
              </div>
              <div className="flex items-center mb-[15px] flex-wrap">
