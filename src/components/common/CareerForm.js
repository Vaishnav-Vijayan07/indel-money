...
export default function CareerForm({ jobId, isGeneral }) {
  ...
  useEffect(() => {
    if (dropdownsLoaded) {
      ...
      if (savedData) {
        ...
        console.log("Auto-filling from cookies:", parsedData);
  ...
  const onSubmit = async (values) => {
    ...
    try {
      ...
      Cookies.set("applicantData", JSON.stringify({ ...values, resume: null }), {
        expires: 7,
        sameSite: "strict",
      });
  ...
  return (
    <div className="p-4">
      ...
      {/* Main Form */}
      <div className={`transition-opacity duration-300 ${isOtpVerified ? "opacity-100" : "opacity-50"}`}>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-wrap -mx-1 lg:-mx-1.5 2xl:-mx-2.5">
            <div className="max-sm:flex items-center hidden p-2.5 bg-white bg-custom-svg mb-5">
              ...
              <div className="text-xs leading-normal font-normal pl-1.5 lg:pl-3.5">
            ...
            <div className="w-full px-1 lg:px-1.5 2xl:px-2.5">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="mb-2 xl:mb-3 2xl:mb-4">
                    <Select onValueChange={field.onChange} value={field.value} disabled={!isOtpVerified}>
            ...
            <div className="max-sm:hidden w-full md:w-[calc(100%-25px)] lg:w-[calc(100%-30px)] xl:w-[calc(100%-35px)] 2xl:w-[calc(100%-45px)] px-1 lg:px-1.5 2xl:px-2.5 mb-2.5 lg:mb-0">
              <FormField
                control={form.control}
                name="resume"
                render={({ field }) => (
                  <FormItem className="mb-2 xl:mb-3 2xl:mb-4">
                    <FormControl>
                      <div className="flex items-center">
                        <label className="text-xs lg:text-sm 2xl:text-base leading-none font-normal text-gray-700 w-25 h-7.5 lg:h-8.5 xl:h-10 flex items-center p-1 lg:p-1.5 2xl:p-2.5 bg-[#b3d5ff] rounded-full cursor-pointer hover:bg-blue-300 transition-colors duration-200">
            ...
            <div className="w-full md:w-25 lg:w-30 xl:w-35 2xl:w-45 px-1 lg:px-1.5 2xl:px-2.5">
              <Button
                className="text-xs lg:text-sm xl:text-base font-bold text-white w-full h-7.5 lg:h-8.5 xl:h-10 flex items-center justify-between bg-base2 rounded-5 p-1 lg:p-1.5 transition-colors duration-300 hover:bg-base2/80 hover:[&>*]:translate-x-1.5"
                type="submit"
