    ...
    <Form {...form}>
      ...
      >
        <div className="max-sm:flex items-center hidden p-[10px] bg-white bg-custom-svg mb-[20px]">
          ...
          <div className="text-[12px] leading-normal font-normal text- pl-[5px] lg:pl-[15px] ">
        ...
        <div className="w-full md:w-[100px] lg:w-[120px] xl:w-[140px] 2xl:w-[180px] 3xl:w-[200px] px-[4px] lg:px-[6px] 2xl:px-[10px]">
          <Button
            className="text-[12px] lg:text-[12px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[18px] leading-[1] font-bold text-white w-full max-w-[100px] md:max-w-[140px] lg:max-w-[160px] 2xl:max-w-[180px] 3xl:max-w-[200px] h-[35px] sm:h-[30px] lg:h-[35px] xl:h-[40px] 2xl:h-[50px] 3xl:h-[55px] flex items-center justify-between bg-base2 rounded-[20px] lg:rounded-[30px] 2xl:rounded-[40px] 3xl:rounded-[60px] p-[4px_6px] sm:p-[4px] lg:p-[6px] 2xl:p-[8px] transition-color duration-300 hover:bg-base2/80 hover:[&>*-translate-x-[5px]]"
            type="submit"
          >
            <span className="px-[4px] lg:px-[15px] 2xl:px-[20px]">Submit</span>
            <Image
