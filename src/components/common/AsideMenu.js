                    ...
                    return (
                        <li key={index}>
                            ...
                            >
                                <Link
                                    href={item.href}
                                    className={`${pathname === item.href ? "text-white font-medium bg-[#de5647] pointer-events-none" : "text-[#050505] font-normal hover:bg-base1/8 bg-transparent "} text-[12px] lg:text-[16px] xl:text-[20px] 2xl:text-[24px] 3xl:text-[30px] text-nowrap text-ellipsis capitalize w-full h-full  block p-[10px_15px] lg:p-[10px_20px] xl:p-[15px_30px] 2xl:p-[20px_40px] 3xl:p-[22px_50px] transition-background duration-300`}
                                >
                                    {item.title}
                                    {pathname === item.href && (
