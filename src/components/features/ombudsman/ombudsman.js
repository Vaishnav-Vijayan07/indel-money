        ...
        <section className="py-[35px] xl:py-[45px] 2xl:py-[65px]">
            <div className="container">
                ...
                <div className="w-full relative">
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-2 xl:gap-4 3xl:gap-6">
                        {schemes.map((scheme, index) => (
                            ...
                            >
                                <h3 className="text-[12px] xl:text-[14px] 2xl:text-[18px] 3xl:text-[20px] font-bold text-black max-w-[260px]">
                                    {scheme.name}
                                </h3>
                                <Link
                                    href={scheme.link}
                                ...
                                >
                                    <span className="text-[10px] xl:text-[12px] 3xl:text-[16px] text-black whitespace-nowrap">
                                        View PDF
                                    </span>
