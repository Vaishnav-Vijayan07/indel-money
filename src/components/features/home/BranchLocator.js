...
export default function BranchLocator({ variant = 'default' }) {
  return (
    <section
      className={`${variant === "contact" ? "bg-[#e6edf7] py-[20px] lg:py-[30px] 2xl:py-[40px] 3xl:py-[50px]" : ""}
                  ${variant === "branch" ? "pt-[40px] pb-[60px] 2xl:pt-[30px] 2xl:pb-[90px] 3xl:pt-[50px] 3xl:pb-[120px]" : ""}
                  w-full block`}
    >
