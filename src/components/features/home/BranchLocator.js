...
const BranchLocationMap = dynamic(() => import("@/components/common/BranchLocationMap"), {
...
export default function BranchLocator({ variant = "default" }) {
  return (
    <section
      className={`${variant === "contact" ? "bg-[#e6edf7] py-[20px] lg:py-[30px] 2xl:py-[40px] 3xl:py-[50px]" : ""} w-full block`}
    >
      <div className="container">
        <div className="mb-7.5 flex flex-col lg:flex-row items-start xl:items-start justify-between flex-wrap">
          <div className="text-title1 w-full lg:w-[calc(100%-468px)] xl:w-[calc(100%-500px)] 2xl:w-[calc(100%-600px)] 3xl:w-[calc(100%-668px)] xl:pr-[20px] 2xl:pr-[60px] 3xl:pr-[80px]">
