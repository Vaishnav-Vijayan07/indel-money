        ...
        <Tabs defaultValue="goldloan" className="w-full gap-0 my-[20px]">
          <TabsList className="w-full p-0">
            <TabsTrigger value="goldloan" className={`${TabsTriggerStyle} before:left-full
             data-[state=active]:bg-[#80808033] before:shadow-[-5px_5px_0_0_#e6e6e6]`}>
              Gold Loan Calculator
            </TabsTrigger>
            <TabsTrigger
              value="emicalculator"
              className={`${TabsTriggerStyle} before:right-full before:scale-x-[-1] 
              data-[state=active]:bg-[#e6e6e6] before:shadow-[-5px_5px_0_0_#e6e6e6]`}
            >
              EMI Calculator
            </TabsTrigger>
          </TabsList>
