    ...
    >
      <div className="container">
        <div className="flex w-full flex-wrap">
          <div className="3xl:w-[calc(100%-750px)] xl:w-[calc(100%-530px)]   md:w-full mb-4">
          ...
          <div className="3xl:w-[750px] xl:w-[530px]  w-full xl:pl-[60px] 2xl:pl-[120px] lg:m-0 m-auto relative z-0">
