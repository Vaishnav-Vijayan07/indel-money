...
const CustomPopup = ({ branch }) => {
  return (
    <div className="popup-content w-64">
      <h3 className="font-bold text-[18px] text-[#1B1B1B] mb-[20px]">
        {branch.name}
      </h3>
      ...
      <div className="flex items-start mb-[15px] flex-wrap">
        ...
        <span className="w-[calc(100%-16px)] pl-[10px] text-[16px] font-normal text-[#1B1B1B] m-0">
          {branch.address}
        </span>
      </div>
      <div className="flex items-center mb-[15px] flex-wrap">
        ...
        <span className="w-[calc(100%-16px)] pl-[10px] text-[16px] font-normal text-[#1B1B1B]">
          {branch.phone}
        </span>
      </div>
      <div className="flex items-center mb-[15px] flex-wrap">
...
export default function BranchLocationMap() {
  ...
  return (
    <div className="w-full h-auto sm:h-[510px] 2xl:h-[670px] relative z-1 flex flex-wrap sm:rounded-[16px] overflow-hidden">
      <div className="w-full max-sm:h-[468px] sm:w-[calc(100%-220px)] lg:w-[calc(100%-260px)] xl:w-[calc(100%-320px)] 2xl:w-[calc(100%-420px)] relative z-0">
        <MapContainer
          center={mapCenter}
          zoom={12}
