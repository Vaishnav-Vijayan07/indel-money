      ...
      <div className="container">
        <div className="max-w-[160px]">
          <h3 className="text-title1 text-black mb-[220px] [&>span]:text-base2 [&>span]:font-bold">
            {pageContent?.features_title ? renderHtml(pageContent?.features_title) : ""}
          </h3>
          <div className="text-[13px] leading-[1.2] font-medium text-[#323232] mb-[15px]">Download our mobile application from:</div>
