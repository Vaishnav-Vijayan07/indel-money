        ...
        <div className="flex flex-wrap -mx-[10px] lg:-mx-[15px] 2xl:-mx-[20px]">
          <div className="w-full sm:w-1/2 p-[10px] lg:p-[15px] 2xl:p-[20px]">
            <motion.div
              ...
              className="w-full h-full bg-[rgba(128,128,128,.2)] rounded-[15px] lg:rounded-[30px] 2xl:rounded-[36px] p-[20px_20px] sm:p-[25px_30px] xl:p-[40px_45px] 2xl:p-[45px_55px] 3xl:p-[50px_65px]"
            >
          ...
          <div className="w-full sm:w-1/2 p-[10px] lg:p-[15px] 2xl:p-[20px]">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="w-full h-full bg-[rgba(128,128,128,.4)] rounded-[15px] lg:rounded-[30px] 2xl:rounded-[36px] p-[20px_20px] sm:p-[25px_30px] xl:p-[40px_45px] 2xl:p-[45px_55px] 3xl:p-[50px_65px]"
            >
              <h2 className="text-[14px] sm:text-[16px] lg:text-[18px] xl:text-[24px] 2xl:text-[28px] 3xl:text-[34px] leading-none font-medium mb-[15px] lg:mb-[20px] 2xl:mb-[30px]">
                EMI Calculator
              </h2>
