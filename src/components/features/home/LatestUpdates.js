        ...
        >
          <div className="w-1/2 p-4 lg:p-6 xl:p-8">
            <div className="flex justify-between items-center gap-2 mb-[10px] xl:mb-[15px] 3xl:mb-[20px]">
              ...
              <Link
                href="/"
                className="text-[12px] lg:text-[12px] 2xl:text-[14px] 3xl:text-[16px] font-bold flex items-center hover:text-base2 transition-color duration-300"
              >
                VIEW ALL
                <Image
            ...
            <LatestUpdatesSlide
              className={
                "relative lg:before:[''] lg:before:block lg:before:absolute lg:before:bottom-0 lg:before:right-0 before:w-[calc(100%-160px)] before:lg:w-[calc(100%-180px)] before:xl:w-[calc(100%-230px)] before:2xl:w-[calc(100%-220px-25px)] before:3xl:w-[calc(100%-320px-30px)] before:h-[1px] before:bg-[#a8a8a8]"
              }
