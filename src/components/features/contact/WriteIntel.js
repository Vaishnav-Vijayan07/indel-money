        ...
        <section className="w-full block py-[30px_40px] lg:py-[40px_60px] 2xl:py-[60px_80px]">
            <div className="container">
                <div className="flex bg-[#cae5f4] rounded-[30px] overflow-hidden">
                    <div className="w-full lg:w-[420px] xl:w-[476px] 2xl:w-[576px] 3xl:w-[700px]">
                    ...
                    <div className="w-full lg:w-[calc(100%-420px)] xl:w-[calc(100%-476px)] 2xl:w-[calc(100%-576px)] 3xl:w-[calc(100%-700px)] flex items-center p-[15px] lg:p-[20px] xl:p-[30px] 2xl:p-[40px] 3xl:p-[50px]">
                        <div>
