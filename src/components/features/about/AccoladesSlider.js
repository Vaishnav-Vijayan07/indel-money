          ...
          <SwiperSlide>
            <div className="flex flex-wrap w-full">
              ...
              <div className="3xl:w-[calc(100%-250px)] 2xl:w-[calc(100%-200px)] w-[calc(100%-150px)] 2xl:pl-[55px] md:pl-[35px] pl-[25px] text-justify">
                <div
                  className="3xl:text-[32px] xl:text-[20px] text-[14px] text-[#5e5959bf] mb-[15px] [&>span]:block [&>span]:font-medium [&>span]:text-black"
                ...
                <Link
                  href="/award"
                  className="3xl:text-[18px] lg:text-[16px] text-[14px] text-white 2xl:h-[50px] h-[40px] w-full overflow-hidden rounded-[50px] bg-base1 max-w-[150px] flex items-center justify-center 2xl:mt-[40px] mt-[20px] lg:ml-auto transition-all duration-300 hover:bg-base2"
                >
                  VIEW ALL
                </Link>
              </div>
