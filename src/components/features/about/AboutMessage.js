          ...
          >
            ...
            <div
              className={`w-[calc(100%-150px)] 3xl:w-[calc(100%-180px)] ${
                index % 2 === 0
                  ? "3xl:pl-[60px] 2xl:pl-[50px] pl-[30px]"
                  : "3xl:pr-[60px] 2xl:pr-[50px] pr-[30px] text-right"
              } 3xl:py-[50px] py-[30px]`}
            >
              <div
                className="text-title1 mb-[25px]"
                dangerouslySetInnerHTML={{ __html: item.title }}
              ></div>
              <p>{item.message}</p>
              <div className="mt-[30px]">
                <div className="text-[16px] xl:text-[18px] 3xl:text-[24px] text-[#0B0B0B] font-medium mb-[5px]">
                  {item.name}
                </div>
                <div className="text-[14px] xl:text-[16px] 3xl:text-[18px] text-[#33538C] font-normal">
                  {item.designation}
                </div>
              </div>
            </div>
