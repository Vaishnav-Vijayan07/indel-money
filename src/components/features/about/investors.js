                ...
                <div className="flex flex-wrap ">
                    <div className="w-full lg:w-[calc(100%-550px)]  xl:w-[calc(100%-600px)] 2xl:w-[calc(100%-740px)] 3xl:w-[calc(100%-940px)] flex items-center max-lg:mb-[20px]">
                        <div className="lg:max-w-[290px] xl:max-w-[400px] 2xl:max-w-[450px] 3xl:max-w-[570px]">
                            ...
                            <p className="3xl:text-[18px]">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature, discovered the undoubtable source.
                                        ...
                                        <div className="w-1/3 m-[-3px]">
                                            <div className="w-full h-full bg-gradient-to-r from-[#1A66F0] to-[#93BFFA] flex items-center justify-center overflow-hidden rounded-[7px]">
                                                <div className="w-full h-fit p-[10px] 2xl:p-[20px] 3xl:p-[27px]">
                                                    <div className="text-[15px] xl:text-[14px] 2xl:text-[18px] 3xl:text-[20px] font-medium text-white mb-[8px]">Listed in</div>
                                                    <div className="text-[20px] xl-[text-[20px] 2xl:text-[22px] 3xltext-[30px] font-bold text-white leading-[1.2]">NSE/BSE</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="w-1/3 m-[-3px]">
                                            <div className="w-full h-full bg-gradient-to-r from-[#FD363B] to-[rgba(235,2,8,0.10)] flex items-center justify-center overflow-hidden rounded-[7px]">
                                                <div className="w-full h-fit p-[10px]  2xl:p-[20px] 3xl:p-[27px]">
                                                    <div className="text-[15px] xl:text-[14px] 2xl:text-[18px] 3xl:text-[20px] font-medium text-white mb-[8px]">Listed in</div>
                                                    <div className="text-[20px] xl-[text-[20px] 2xl:text-[22px] 3xltext-[30px] font-bold text-white leading-[1.2]">Stock Market</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="w-1/3 m-[-3px]">
                                            <div className="w-full h-full bg-gradient-to-r from-[#1A66F0] to-[#93BFFA] flex items-center justify-center overflow-hidden rounded-[7px]">
                                                <div className="w-full h-fit p-[10px] 2xl:p-[20px] 3xl:p-[27px]">
                                                    <div className="text-[20px] xl-[text-[20px] 2xl:text-[22px] 3xltext-[30px] font-bold text-white mb-[8px]">500cr +</div>
                                                    <div className="text-[15px] xl:text-[14px] 2xl:text-[18px] 3xl:text-[20px] font-medium text-white leading-[1.2]">Company total revenue</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
