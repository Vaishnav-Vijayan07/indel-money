...
export default function Countersec() {
    return (
        <div className="flex flex-wrap w-full m-[-10px] items-end 3xl:h-[370px] 2xl:h-[300px] h-[260px]">
            {/* Card 1 */}
            <div className="w-[calc(100%/4)] 3xl:p-[10px] p-[5px] h-full flex flex-col-reverse">
                <div className="relative w-full h-full rounded-[25px] pt-[25px] px-[20px] overflow-hidden bg-[linear-gradient(156deg,rgba(23,71,158,0.30)_6.47%,rgba(198,59,59,0.30)_91.2%)] flex flex-col justify-between">
                    ...
                    <div className="w-full 3xl:max-w-[180px] 2xl:max-w-[125px] max-w-[90px]  m-auto">
            ...
            {/* Card 2 */}
            <div className="w-[calc(100%/4)] 3xl:p-[10px] p-[5px] h-full flex flex-col-reverse">
                <div className="relative w-full h-[calc(100%-50px)] rounded-[25px] py-[25px] px-[20px] overflow-hidden bg-[linear-gradient(156deg,rgba(23,71,158,0.30)_6.47%,rgba(198,59,59,0.30)_91.2%)] flex flex-col justify-between">
                    <div className="text-black text-[30px] sm:text-[25px] 2xl:text-[30px] 3xl:text-[43px] font-bold leading-[1.2] mb-[10px]">
                    ...
                    <div className="w-full 3xl:max-w-[180px] 2xl:max-w-[125px] max-w-[90px]">
            ...
            {/* Card 4 */}
            <div className="w-[calc(100%/4)] 3xl:p-[10px] p-[5px]  h-full flex flex-col-reverse">
                <div className="relative w-full rounded-[25px] h-[calc(100%-50px)] pt-[25px] px-[20px] overflow-hidden bg-[linear-gradient(156deg,rgba(23,71,158,0.30)_6.47%,rgba(198,59,59,0.30)_91.2%)] ">
                    <div className="text-black text-[30px] sm:text-[25px] 2xl:text-[30px] 3xl:text-[43px] font-bold leading-[1.2] mb-[10px]">
