              ...
              <div
               ...
               w-full h-auto bg-white rounded-[28px] shadow-[0_0_50px_0_rgba(0,0,0,0.25)] p-[15px_20px_40px] 4xs:p-[20px_30px_50px]`}>
                <div className="flex items-center gap-[10px] 4xs:gap-[20px] mb-[20px]">
                  ...
                  <div>
                    <h4 className="text-[16px] 4xs:text-[18px] leading-none line-clamp-1 font-semibold text-[#5e5959bf] mb-[8px] [&>span]:text-bold [&>span]:text-base2">
                      {item?.title ? renderHtml(item?.title) : "Message from Chairman"}
                    </h4>
                    <h5 className="text-[12px] 4xs:text-[14px] leading-none line-clamp-1 font-medium text-[#5e5959bf] mb-[5px]">
                      {item.full_name}
                    </h5>
                ...
                </div>
                {
                  isExpanded
                    ...
                    : parse(getTextPreview(item.description)) // Preview with tags
                }
                <div
