            ...
            <div className="lg:max-w-[290px] xl:max-w-[400px] 2xl:max-w-[450px] 3xl:max-w-[570px]">
              ...
              <Link
                ...
                className="group btn btn-base1 relative z-0 flex items-center justify-between mt-[15px] lg:mt-[30px] w-full max-w-[200px] 2xl:max-w-[260px]
                 3xl:max-w-[270px] pr-3 pl-5 h-[45px] lg:h-[40px] 2xl:h-[50px] 3xl:h-[60px] rounded-full bg-base2 text-white font-bold transition-all duration-300 
                 overflow-hidden shadow-lg hover:bg-base1"
              >
                ...
                3xl:h-[48px] bg-base1 rounded-full text-red-500 transition-all duration-300  group-hover:translate-x-2 group-hover:bg-red-600 group-hover:text-white">
