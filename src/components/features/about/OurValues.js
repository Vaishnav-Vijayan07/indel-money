        ...
        <section className="w-full pt-[30px] xl:pt-[60px] 2xl:pt-[100px] pb-[30px] sm:pb-[50px] xl:pb-[30px] lg:pb-[40px] 2xl:pb-[70px]">
            <div className="container">
                <div className="flex flex-wrap -my-[12px] sm:-my-[15px] xl:-my-[20px] 2xl:-my-[30px] -mx-[10px] xl:-mx-[15px] 2xl:-mx-[20px]">
                    ...
                    <div className="w-2/4 lg:w-1/3 py-[15px] xl:py-[20px] 2xl:py-[30px] px-[10px] xl:px-[15px] 2xl:px-[20px] hidden sm:block">
...
export function ValueBox({ item }) {
    return (
        <div className="w-full h-full relative overflow-hidden bg-white shadow-[0_0_28px_rgba(0,0,0,0.10)] p-[20px] xl:p-[30px] 2xl:p-[40px] rounded-[10px] sm:rounded-[20px] transition-transform duration-600 hover:transform hover:translate-y-2 2xl:hover:translate-y-4">
            ...
            <div className="text-black font-medium 2xl:font-normal leading-[1.1] text-[18px] 3xs:text-[20px] sm:text-[18px] xl:text-[20px] 2xl:text-[24px] 3xl:text-[28px] mb-[20px] xl:min-h-[40px] 2xl:min-h-[50px] 3xl:min-h-[60px]">
                {item.title}
            </div>
