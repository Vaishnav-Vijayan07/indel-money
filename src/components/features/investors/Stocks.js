...
export default function StockExchange() {
  ...
  const fetchStocksData = async (year) => {
    try {
                    ...
                    <AccordionContent>
                      ...
                      <div className="mb-[20px] xl:mb-[25px]">
                        <div className="text-[18px] lg:text-[26px] xl:text-[28px] 2xl:text-[35px] 3xl:text-[42px] font-normal sm:font-medium text-black mb-[20px] xl:mb-[25px]">
                          1. Board Meeting {year?.fiscal_year}
                        </div>
                          ...
                          <table className="w-full border-collapse rounded-[20px] px-[55px] 3xl:px-[76px] bg-[#D7E9FF] overflow-hidden">
                            <thead>
                              <tr className="bg-[#CDE2FF] text-left text-gray-800">
                                ...
                                <th className="text-[12px] sm:text-[14px] 2xl:text-[18px] 3xl:text-[20px] font-bold py-[12px] 3xl:py-[18px] pl-[30px] xl:pl-[55px] 3xl:pl-[76px] pr-[10px] bg-[#CDE2FF] break-spaces sm:whitespace-nowrap">
                                  Outcome
                                </th>
                              </tr>
                            </thead>
                            <tbody>
                              {meetings?.filter(m => m.fiscal_year === year.id)?.map((stock, index) => (
                      ...
                      <div className="mb-[20px] xl:mb-[25px]">
                        ...
                        <div className="overflow-auto w-full">
                          <table className="w-full border-collapse rounded-[20px] px-[55px] 3xl:px-[76px] bg-[#CDE2FF] overflow-hidden">
                            ...
                            <tbody>
                              {intimations?.filter(m => m.fiscal_year === year.id)?.map((intimation, index) => (
                                <tr key={index} className="bg-[#E7EFF6] border-t border-[#E5F0FA]">
                                  <td className="text-[14px] 2xl:text-[18px] 3xl:text-[20px] text-[#1F1B1B] font-medium pl-[30px] xl:pl-[55px] 3xl:pl-[76px] pr-[10px] py-[12px] 3xl:py-[18px] border-r border-r-[rgba(32,35,102,0.12)] whitespace-nowrap">
                                    {intimation?.month_date}
                                  </td>
