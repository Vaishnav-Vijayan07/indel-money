...
export default function Disclosure({ contents }) {


    return (
        <section className="pt-[25px] 3xl:pt-[50px]">
            <div className="text-black text-title1 font-medium mb-[20px] 2xlmb-[30px] 3xl:mb-[40px]">{contents.disclosure_title ? contents.disclosure_title : "Liquidity Risk Disclosure"}</div>
            ...
            <div className="flex items-center justify-between px-[15px] sm:px-[25px] py-[15px] 3xl:px-[35px] 3xl:py-[25px] bg-[#DCEAFB] rounded-[16px] 3xl:rounded-[24px] overflow-hidden">
                ...
                {
                    contents?.disclosure_file && contents?.disclosure_file !== "" ? (
                        <Link
                            href={`${process.env.NEXT_PUBLIC_BACKEND_URL}${contents?.disclosure_file}`}
                            target="_blank"
