        ...
        <section className="pb-[25px] 3xl:pb-[50px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 xl:gap-4 3xl:gap-6">
                {reports.map((report, index) => (
                    <div
                        key={index}
                        className="flex items-center flex-wrap justify-between py-[25px] px-[15px] xl:py-[30px] xl:px-[20px] 3xl:py-[35px] 3xl:px-[25px] rounded-2xl bg-gradient-to-r from-blue-300 to-red-300 shadow-md"
                    >
                        <h3 className="text-[12px] xl:text-[14px] 2xl:text-[18px] 3xl:text-[20px] font-bold text-black">{`Annual Report ${report.year}`}</h3>
                        <Link
                            href={report.link}
                            target="_blank"
                        ...
                        >
                            <span className="text-[10px] xl:text-[12px] 3xl:text-[16px] text-black">View PDF</span>
