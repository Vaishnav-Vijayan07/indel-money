        ...
        <section className="pb-[25px] 3xl:pb-[50px]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-2 xl:gap-4 3xl:gap-6">
                {reports.map((report, index) => (
                    <div
                        key={index}
                        className="flex items-center flex-wrap justify-between py-[15px] sm:py-[25px] px-[12px] sm:px-[15px] xl:py-[30px] xl:px-[20px] 3xl:py-[35px] 3xl:px-[25px] rounded-2xl bg-gradient-to-r from-blue-300 to-red-300 shadow-md">
                        ...
                        <h3 className="text-[13px] xl:text-[14px] 2xl:text-[18px] 3xl:text-[20px] sm:font-bold font-medium text-blacksm:block flex flex-wrap sm:w-fit w-[calc(100%-15px)]">
                        ...
                        <Link
                            ...
                            <div className="w-[36px] sm:w-[20px] h-[36px] sm:h-[20px] xl:w-[30px] xl:h-[30px] 3xl:w-[40px] 3xl:h-[40px] bg-red-500 rounded-full flex items-center justify-center">
                                <Image
                                    src="/images/pdf-icon.svg"
                                    alt="PDF Icon"
                                    width={24}
                                    height={24}
                                    className="w-[15px] sm:w-[10px] h-[18px] sm:h-[10px] xl:w-[15px] xl:h-[15px] 2xl:w-[20px] 2xl:h-[20px] 3xl:w-[24px] 3xl:h-[24px]"
                                />
                            </div>
                        </Link>
                    </div>
