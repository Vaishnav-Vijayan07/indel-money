                    ...
                    <div className="w-[calc(100%-300px)] xl:w-[calc(100%-330px)] 2xl:w-[calc(100%-400px)] 3xl:w-[calc(100%-510px)] pl-[50px] 2xl:pl-[80px] 3xl:pl-[100px]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 xl:gap-4 3xl:gap-6">
                            {pdfItems.map((item, index) => (
                                <div
                                    key={index}
                                    className="py-[25px] px-[15px] xl:py-[30px] xl:px-[20px] 3xl:py-[35px] 3xl:px-[25px] rounded-2xl bg-gradient-to-r from-[rgba(23,71,158,0.40)] to-[rgba(238,56,36,0.40)] shadow-md min-h-[100px] 2xl:min-h-[120px] 3xl:min-h-[150px]"
                                >
                                    <h3 className="text-[12px] xl:text-[14px] 2xl:text-[18px] 3xl:text-[20px] font-bold text-black max-w-[85%]">
                                        {item.title}
                                    </h3>
                                    <Link
                                        href={item.link}
                                        ...
                                        className="flex items-center space-x-2 w-fit ml-auto mt-[25px]"
                                    >
                                        <span className="text-[10px] xl:text-[12px] 3xl:text-[16px] text-black">
                                            View PDF
                                        </span>
