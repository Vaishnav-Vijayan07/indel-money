                ...
                <div className="flex flex-wrap">
                        ...
                        <div className="w-full sm:max-w-[180px] lg:max-w-[210px] xl:max-w-[236px] 2xl:max-w-[325px] relative z-1 sm:mb-0 mb-[40px]">
                            <h2 className="font-normal text-black leading-normal text-[18px] md:text-[20px] lg:text-[24px] xl:text-[28px] 2xl:text-[34px] 3xl:text-[40px] mb-[15px] 2xl:mb-[20px] 3xl:mb-[25px] [&>span]:text-base2 [&>span]:font-bold"
                                dangerouslySetInnerHTML={{
                                    __html: title ? title : "Products Covered <span class='text-base2 font-bold'>under Consumer Durable Loan</span>"
                                }} />
                            ...
                            <div className="relative z-1 flex flex-wrap sm:-my-[5px] 2xl:-my-[8px] sm:-mx-[10px] 2xl:-mx-[15px] bg-[#FFF] sm:bg-[#0000] sm:rounded-[0px] rounded-[15px] sm:py-0 py-[20px] sm:px-0 px-[20px]">
                                {products?.map((item, index) => (
                                    <div key={item?.id} className="w-full 4xs:w-1/2 sm:w-full py-[5px] 2xl:py-[8px] px-[10px] 2xl:px-[15px] transition-transform duration-600 hover:ml-[5px]">
                    ...
                    <div className="w-full md:w-[285px] xl:w-[400px] 2xl:w-[500px] 3xl:w-[590px] pl-[25px] xl:pl-[45px] 2xl:pl-[55px] 3xl:pl-[75px] pb-[30px] xl:pb-[40px] 2xl:pb-[60px] pt-[30px] xl:pt-[40px] 2xl:pt-[70px] 3xl:pt-[90px] bg-[#C0DBFF] relative z-1 sm:block hidden">
                        <div className="flex items-center mb-[10px] 2xl:mb-[20px]">
                            ...
                            <h2 className="text-[20px] xl:text-[26px] 2xl:text-[32px] 3xl:text-[40px] font-normal text-[#141414] pl-[15px] [&>span]:text-base2 [&>span]:font-bold]" dangerouslySetInnerHTML={{
                        ...
                        <div className="text-sm1 font-medium max-w-[70%]">
                            {criteriaNote ? criteriaNote : "Note: The eligibility criteria may vary based on the lender's policies and the applicant's financial profile."}
                        </div>
                    </div>
                </div>
            </div>
