...
import LoanCardBx from "@/components/features/loanAgainstProperty/LoanCardBx";
...
const slides = [
  ...
  },
  {
    ...
    description:
      "The key success factor of every Loan Against Property sector enterprise is ready availability of credit to facilitate working capital or fixed asset purchase requirements. ",
    href: "/",
  },
  {
