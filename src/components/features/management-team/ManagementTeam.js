    ...
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <div className="w-full h-full sm:h-fit cursor-pointer sm:px-0 px-[10px] sm:py-0 py-[20px] bg-white shadow-[0_0_50px_rgba(0,0,0,0.15)] sm:bg-none sm:shadow-none overflow-hidden sm:rounded-0 rounded-[10px]">
          <div className="relative m-auto sm:m-0 group w-[100px] sm:w-full h-[100px] sm:h-full rounded-full sm:rounded-[15px] md:rounded-[18px] xl:rounded-[20px] overflow-hidden aspect-100/100 sm:aspect-380/455 sm:p-0 p-[15px] pb-0">
