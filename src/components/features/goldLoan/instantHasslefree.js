...
export default function InstantHasslefree() {
    ...
    return (
        <section className="py-[35px] xl:py-[45px] 2xl:py-[65px] bg-[linear-gradient(90deg,#CDDFFF_1%,#FFD2D2_99%)]">
                        ...
                        <div className="w-full bg-white rounded-[24px] p-[20px] 2xl:p-[25px] mt-[25px]">
                            <ul className="flex flex-wrap">
                                {features.map((feature, index) => (
                                    <li
                                        key={index}
                                        className={`${index % 2 === 0 ? "w-[230px] 2xl:w-[300px] max-w-[50%]" : "w-[calc(100%-230px)] 2xl:w-[calc(100%-300px)]"
                                            } 3xl:text-[18px] 2xl:text-[14px] text-[12px] text-[#000] relative mb-[15px] flex flex-wrap`}
                                    >
