                    ...
                    {faqs.map((faq, index) => (
                        ...
                        >
                            ...
                            >
                                ...
                                {openIndex === index ? (
                                    <Minus className="relative text-white bg-base2 rounded-full 2xl:w-[33px] 3xl:h-[33px] w-[22px] h-[22px] p-[3px] transition-all duration-300 xl:top-[25px]" size={17} />
                                ) : (
                                    <Plus className="relative text-white bg-base2 rounded-full 2xl:w-[33px] 3xl:h-[33px] w-[22px] h-[22px] p-[3px] transition-all duration-300 xl:top-[25px]" size={17} />
                                )}
                            </button>
                            {openIndex === index && (
