    ...
    <section className="py-[35px] xl:py-[45px] 2xl:py-[65px] bg-[rgba(128,128,128,.2)]">
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap items-center">
          {/* Title */}
          <h2
            className="w-full xl:w-[calc(100%-700px)] 2xl:w-[calc(100%-950px)] 3xl:w-[calc(100%-1020px)] text-[#5e5959bf] text-title1 font-normal max-xl:mb-[20px] [&>span]:text-base2 [&>span]:font-bold"
            ...
            >
              {schemes?.map((type, index) => (
                <SwiperSlide key={index}>
                  <h4
                    className={`w-full h-[40px] 2xl:h-[50px] 3xl:h-[60px]  text-[#5e5959bf] text-[12px] 2xl:text-[16px] 3xl:text-[18px] px-[10px] font-bold flex items-center justify-center rounded-[100px] cursor-pointer transition-all duration-300 text-center
                ...
                <div className="flex flex-wrap m-[-8px] 3xl:m-[-12px] py-[15px]">
                  {detailsArray?.length > 0 ? (
                    detailsArray?.map((detail, detailIndex) => (
                      ...
                      >
                        <div className="w-full h-full shadow-[0_0_10px_rgba(0,0,0,0.20)]  bg-[#C0BFC0] text-center rounded-[15px] 3xl:rounded-[25px] overflow-hidden">
                          ...
                          <div className="text-[#fff] text-[12px] 2xl:text-[18px] 3xl:text-[24px] font-bold 
