      ...
      <div className="container">
        <div className="flex flex-wrap">
          ...
          <div className="w-full xl:w-[calc(100%-450px)] 2xl:w-[calc(100%-550px)] 3xl:w-[calc(100%-700px)] xl:pl-[50px] 3xl:pl-[70px] max-lg:mb-[25px]">
            ...
            <h2
              className="text-title1 font-normal text-[#5e5959bf] mb-[15px] 2xl:mb-[30px] 3xl:mb-[40px] [&>span]:text-base2 [&>span]:font-bold"
              ...
              <ul className="flex flex-wrap">
                {GoldloanBenefits?.map((feature, index) => (
                  <li
                    key={index}
                    className={`${
                      index % 2 === 0 ? "w-[230px] 2xl:w-[300px] max-w-[50%]" : "w-[calc(100%-230px)] 2xl:w-[calc(100%-300px)]"
