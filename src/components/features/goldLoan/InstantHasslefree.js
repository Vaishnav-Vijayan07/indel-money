...
export default function InstantHasslefree({ title, description }) {
  return (
      ...
      <div className="container">
        <div className="flex flex-wrap">
          ...
          <div className="w-full xl:w-[calc(100%-450px)] 2xl:w-[calc(100%-550px)] 3xl:w-[calc(100%-700px)] xl:pl-[50px] 3xl:pl-[70px] max-lg:mb-[25px]">
            {/* <div className="text-title1 font-normal text-black mb-[15px] 2xl:mb-[30px] 3xl:mb-[40px] [&<span>]:text-base2 [&<span>]:font-bold">
              Instant & hassle free <br />
              <span className="text-base2 font-bold">Gold Loan</span>
            </div> */}
            <div className="text-title1 font-normal text-black mb-[15px] 2xl:mb-[30px] 3xl:mb-[40px] [&>span]:text-base2 [&>span]:font-bold" dangerouslySetInnerHTML={{ __html: title ? title : "Instant & hassle free <br></br> <span>Gold Loan</span>" }} />

            <p>
              {description
                ? description
                : `
                  Availing gold loan from Indel Money branches is super easy.
                  You just walk into your nearest Indel Money branch with your
                  jewellery to get maximum value for your gold and receive the
                  loan at our instant counter processing with minimal
                  documentation, the shortest processing time and low interest
                  rates. We yearn for customer satisfaction and our happiness
                  lies in serving you best.
                `}
            </p>
