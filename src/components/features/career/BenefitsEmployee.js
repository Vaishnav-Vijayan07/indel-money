            ...
            <div className="container">
                <div className="text-title1 font-medium capitalize flex items-center mb-[10px] lg:mb-[15px] 2xl:mb-[20px] 3xl:mb-[40px]">
                    <Image
                        ...
                        width={50}
                        height={50}
                        className="inline aspect-square mr-[10px] lg:mr-[15px] 2xl:mr-[20px]"
                    />
                ...
                <div className="flex flex-wrap -mx-[20px] lg:-mx-[30px] 2xl:-mx-[40px]">
                    <div className="flex flex-wrap">
                        {benefitsEmployee?.map((item, index) => (
                            <div
                                key={index}
                                className="w-1/3 p-[5px_20px] lg:p-[10px_30px] 2xl:p-[15px_40px]"
                            >
                                <div
                                    className={`
                                ...
                                >
                                    <div className={`
                                        ...
                                        w-[60px] lg:w-[80px] 2xl:w-[100px] 3xl:w-[120px] p-[20px_10px] lg:p-[30px_15px] 2xl:p-[40px_20px] flex items-center justify-center`}>
                                        <Image
                                            src={item.src}
                                            alt={item.alt}
                                            width={70}
                                    ...
                                    <div className="w-[calc(100%-60px)] lg:w-[calc(100%-80px)] 2xl:w-[calc(100%-100px)] 3xl:w-[calc(100%-120px)] p-[20px_10px] lg:p-[30px_15px] 2xl:p-[40px_20px] flex flex-col justify-center">
