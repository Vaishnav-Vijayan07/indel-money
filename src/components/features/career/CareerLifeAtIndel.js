        ...
        <section className="w-full block py-[20px_20px] lg:py-[40px_30px] 2xl:py-[60px_40px] 3xl:py-[80px_50px] relative z-0">
            ...
            <div className="w-full max-w-[calc(100%-((100%-var(--container-x))/2))] pl-[var(--container-padding)] ml-auto">
                <div className="flex flex-wrap">
                    <div className="w-full lg:w-[376px] xl:w-[420px] 2xl:w-[576px] 3xl:w-[676px]">
                    ...
                    <div className="w-full lg:w-[calc(100%-376px)] xl:w-[calc(100%-420px)] 2xl:w-[calc(100%-576px)] 3xl:w-[calc(100%-676px)] px-[4px] lg:px-[6px] 2xl:px-[10px]">
                        <div className="flex flex-wrap -my-[4px] lg:-my-[6px] 2xl:-my-[10px]">
                            ...
                            <div className="w-[30%]">
                                {careerLifeAtIndelImages?.slice(0, 2).map((item, index) => (
                                    <div
                                        key={item.id}
                                        className="w-full h-[140px] lg:h-[220px] 2xl:h-[320px] [&:nth-child(2)]:h-[180px] lg:[&:nth-child(2)]:h-[240px] 2xl:[&:nth-child(2)]:h-[360px] p-[4px] lg:p-[6px] 2xl:p-[10px]"
                                    >
                                        <ImageBox item={item} />
                                    </div>
                                ))}
                            ...
                            <div className="w-[35%]">
                                {careerLifeAtIndelImages?.slice(2, 4).map((item, index) => (
                                    <div
                                        key={item.id}
                                        className="w-full h-[140px] lg:h-[160px] 2xl:h-[240px] [&:nth-child(2)]:h-[220px] lg:[&:nth-child(2)]:h-[300px] 2xl:[&:nth-child(2)]:h-[440px] p-[4px] lg:p-[6px] 2xl:p-[10px]"
                                    >
                                        <ImageBox item={item} />
                                    </div>
                                ))}
                            ...
                            {careerLifeAtIndelImages?.length > 4 && (
                                <div className="w-[35%]">
                                    <div
                                        ...
                                        className="w-full h-[360px] lg:h-[460px] 2xl:h-[680px] p-[4px] lg:p-[6px] 2xl:p-[10px]"
                                    >
                            ...
                            {careerLifeAtIndelImages?.slice(5).map((item) => (
                                <div key={item.id} className="w-[25%]">
                                    <div className="w-full h-[140px] lg:h-[180px] 2xl:h-[240px] p-[4px] lg:p-[6px] 2xl:p-[10px]">
                                        <ImageBox item={item} />
                                    </div>
                                </div>
                            ))}
