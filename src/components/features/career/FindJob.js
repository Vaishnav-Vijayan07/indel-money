...
function JobLocationBox({ item }) {
    return (
        <Link href={"/"} className={`${item.is_active ? "group opacity-100 grayscale-0 cursor-pointer" : "opacity-80 grayscale-100 cursor-default"} w-full h-auto aspect-220/160 bg-white rounded-[7px] sm:rounded-[15px] lg:rounded-[20px] 2xl:rounded-[24px] overflow-hidden block relative z-0`}>
            <Image
                src={item?.image ? `${process.env.NEXT_PUBLIC_BACKEND_URL}${item?.image}` : "/images/job-location-1.jpg"}
...
export default function FindJob({ find_job_title, find_job_button_name, find_job_button_link, states, jobs }) {
    return (
        <section className="w-full block p-[30px_0_30px] sm:py-[40px_20px] lg:py-[60px_30px] 2xl:py-[80px_40px] 3xl:py-[100px_50px] relative z-0 after:content-[''] after:w-full after:h-[50%] after:absolute after:-z-1 after:bottom-0 after:left-0 after:right-0 after:block after:bg-gradient-to-r after:to-[#fde7e7] after:from-transparent after:max-sm:h-[100%] after:max-sm:bg-[linear-gradient(0deg,rgba(238,238,238,0.00)_0%,rgba(243,0,0,0.10)_0%,rgba(243,0,0,0.10)_100%)]">
            <div className="container">
                <div className="flex justify-between mb-[10px] lg:mb-[15px] 2xl:mb-[20px] max-sm:hidden">
                    <div className="text-title1 font-bold [&>span]:font-bold  [&>span]:text-base2 " dangerouslySetInnerHTML={{ __html: find_job_title ? find_job_title : "" }} />
                    ...
                    <div className="max-sm:hidden block">
                        <Link
                            href={find_job_button_link ? find_job_button_link : "/career/active-jobs"}
                ...
                <div className="max-sm:flex max-sm:flex-col-reverse">
                    ...
                    >
                        <div className="max-sm:flex hidden max-sm:p-[0px_0_20px]">
                            <div className="text-title1 font-bold [&>span]:text-base2 [&>span]:font-bold" dangerouslySetInnerHTML={{ __html: find_job_title ? find_job_title : "" }} />
