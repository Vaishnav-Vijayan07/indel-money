    ...
    <div className="w-full h-auto block max-sm:flex max-sm:flex-col-reverse">
      ...
      <div className="max-w-[90%] flex">
        ...
        <div className="flex flex-wrap max-sm:pl-[12px]">
          ...
          <div className="w-full h-[20px] lg:h-[30px] 2xl:h-[40px] flex">
            <div className="w-auto min-w-[80%] h-[20px] lg:h-[30px] 2xl:h-[40px] min-sm:bg-base1 rounded-[0_10px_10px_0] lg:rounded-[0_15px_15px_0] 2xl:rounded-[0_20px_20px_0] inline-flex items-center pr-[10px] lg:pr-[15px] 2xl:pr-[20px] 3xl:pr-[30px]">
