    ...
    return (
        <div className='w-full h-auto block'>
            ...
            <div className="max-w-[90%] flex">
                <div
                    className="w-[40px] lg:w-[60px] 2xl:w-[80px] h-[40px] lg:h-[60px] 2xl:h-[80px] flex items-center justify-center bg-base1 rounded-[10px_0_0_10px] lg:rounded-[15px_0_0_15px] 2xl:rounded-[20px_0_0_20px]"
                >
                    <div
