        ...
        <div className="flex flex-wrap relative z-1">
          <div className="w-full lg:w-[220px] xl:w-[300px] 2xl:w-[350px] 3xl:w-[420px] py-[40px] lg:py-[120px] flex items-end">
            <div className=" w-full">
              <div className="text-title2 text-white [&>span]:text-base2 [&>span]:font-bold]">{title}</div>
            </div>
          </div>
              ...
              <div className="relative flex justify-center max-w-[525px] 3xl:max-w-[760px] w-[calc(100%-120px)] 3xl:w-[calc(100%-200px)]">
                ...
                <div className="w-[calc(100%-75px)] 2xl:w-[100%-110px] 3xl:w-[calc(100%-120px)]">
                  <Swiper
                    ...
                    className="h-[430px] xl:h-[550px] 2xl:h-[580px] 3xl:h-[600px]"
                        ...
                        <div className="flex flex-wrap items-start text-white relative h-full">
                          <div className="w-[70px] 2xl:w-[100px] relative h-full">
                            ...
                            {index !== inceptionslides?.length - 1 && (
                              <div className="absolute bg-base2 w-[2px] left-0 2xl:left-0 right-0 m-auto bottom-0 h-[calc(100%-80px)] 3xl:h-[calc(100%-150px)] before:content-[''] before:absolute before:top-0 before:left-[-5px] before:m-auto before:w-[12px] before:h-[12px] before:bg-white before:rounded-full">
                          ...
                          <div className="w-[calc(100%-100px)] pl-[30px] 2xl:pl-[40px] 3xl:pl-[70px] h-full flex flex-wrap item-center">
                            <div className="w-full h-auto justify-start flex flex-wrap item-center">
                              ...
                              <h3 className="text-[16px] 2xl:text-[20px] 3xl:text-[22px] text-left text-white font-semibold mb-[5px] 2xl:mb-[10px]">
                                {item?.title}
                              </h3>
