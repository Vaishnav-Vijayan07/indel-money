...
const yearStyle = "text-[20px] 4xs:text-[30px] leading-none font-bold text-white";

export default function MobYearsInception({ inceptionslides, title, years }) {
    ...
    <section className="w-full block bg-[#003595]">
      <div className="container">
        <div className="text-[24px] leading-none font-medium text-white flex items-center py-[30px]">
          <span className="text-[48px] 4xs:text-[72px] xs:text-[90px] leading-none font-bold text-base2 mr-[25px]">{years ? years : "0"}</span>
          {title ? title : "Years of Inception"}
        </div>
      </div>
          ...
          <div className="flex flex-wrap w-full justify-between">
            <div className="relative flex justify-center w-[calc(100%-60px)] 4xs:w-[calc(100%-80px)]">
              <div className="relative z-1 w-[28px] 4xs:w-[40px]">
                <div className={yearStyle}>{inceptionslides?.[activeIndex]?.year.slice(0, 2)}</div>
              </div>
            ...
            <div className="relative w-[60px] 4xs:w-[80px] flex flex-col items-center justify-between h-[350px] my-auto mx-0 custom-pagination-wrapper">
              <div className="text-[12px] text-white mb-2">{inceptionslides?.[0]?.year}</div>
              ...
              <div className="text-white text-[12px] mt-2">{inceptionslides?.[inceptionslides?.length - 1]?.year}</div>
            </div>
          </div>
        </div>
      </div>
