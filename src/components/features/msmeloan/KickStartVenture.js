        ...
        <section className="w-full py-[20px] md:py-[20px] xl:pt-[30px] 2xl:py-[50px] 3xl:py-[70px]">
            <div className="container">
                <div className="flex flex-wrap lg:-mx-[40px]">
                    ...
                    <div className="w-full lg:w-5/10 lg:px-[40px] pt-[30px] lg:pt-0">
                        ...
                        <div className="flex flex-wrap justify-center -m-[5px] 2xl:-m-[7.5px]">
                            <div className="w-[45%] xl:w-[40%] 2xl:w-1/3 p-[5px] 2xl:p-[7.5px] pl-[30px]">
                                <div className="rounded-[10px] bg-white shadow-[0px_0px_50px_rgba(0,0,0,0.10)] flex flex-col items-center  px-[10px] xl:px-[15px]  2xl:px-[20px] py-[15px] xl:py-[20px]  2xl:py-[30px]">
                                    <div className="w-[25px] xl:w-[30px] 2xl:w-[40px] 3xl:w-[45px] h-[25px] xl:h-[30px] 2xl:h-[40px] 3xl:h-[45px] mr-auto">
                                        <Image
                            ...
                            <div className="w-[55%] xl:w-[60%] 2xl:w-2/3 p-[5px] 2xl:p-[7.5px] content-end">
                                <div className="rounded-[10px] h-fit bg-white shadow-[0px_0px_50px_rgba(0,0,0,0.10)] px-[10px] xl:px-[15px]  2xl:px-[20px] py-[15px] xl:py-[20px]  2xl:py-[30px] flex items-center">
                            ...
                            <div className="w-[60%] xl:w-[65%] 2xl:w-2/3 content-end">
                                <div className="p-[5px] 2xl:p-[7.5px]">
                                    <div className="rounded-[10px] h-fit bg-white shadow-[0px_0px_50px_rgba(0,0,0,0.10)] px-[10px] xl:px-[15px]  2xl:px-[20px] py-[25px] 2xl:py-[30px] 3xl:py-[40px] flex items-center">
                                ...
                                <div className="w-full p-[5px] 2xl:p-[7.5px] justify-items-end">
                                    <div className="rounded-[10px] w-fit h-fit bg-white shadow-[0px_0px_50px_rgba(0,0,0,0.10)] px-[10px] xl:px-[15px]  2xl:px-[20px] py-[25px] 2xl:py-[30px] 3xl:py-[40px] flex items-center">
                                        <div className="w-[25px] xl:w-[30px] 2xl:w-[40px] 3xl:w-[45px] h-[25px] xl:h-[30px] 2xl:h-[40px] 3xl:h-[45px]">
                                            <Image
                            ...
                            <div className="w-[40%] xl:w-[35%] 2xl:w-1/3 p-[5px] 2xl:p-[7.5px]">
                                <div className="rounded-[10px] h-fit bg-white shadow-[0px_0px_50px_rgba(0,0,0,0.10)] px-[10px] xl:px-[15px]  2xl:px-[20px] py-[40px] 2xl:py-[50px] 3xl:py-[60px]  flex items-center">
                                    <div className="w-[25px] xl:w-[30px] 2xl:w-[40px] 3xl:w-[45px] h-[25px] xl:h-[30px] 2xl:h-[40px] 3xl:h-[45px]">
                                        <Image
