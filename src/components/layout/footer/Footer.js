...
function ContactBox({ href, src, title, alt }) {
  return (
    <a
      ...
      style={{ minHeight: 36 }} // Reserve space for icon+text
    >
      <span>
        <Image src={src} width={30} height={30} alt={alt} style={{ width: 30, height: 30, minWidth: 30, minHeight: 30 }} />
      </span>
...
export default function Footer({ content, icons }) {
  ...
  return (
    <footer className="w-full block bg-[#e6edf7] pt-[30px] lg:pt-[40px] xl:pt-[60px] 3xl:pt-[80px] pb-[15px] lg:pb-[20px] xl:pb-[30px] 3xl:pb-[40px]">
      <div className="container">
        <div className="flex flex-wrap mx-0 lg:-mx-[20px] xl:-mx-[30px] 3xl:-mx-[35px] mb-[10px] lg:mb-[30px] xl:mb-[40px] 3xl:mb-[60px]">
          <div className="w-full lg:w-3/10 py-[10px] lg:py-0 lg:px-[20px] xl:px-[30px] 3xl:px-[35px]">
            <div className="w-full mb-4 xl:mb-6" style={{ minHeight: 60 }}>
              <Image
                src={content?.logo ? `${process.env.NEXT_PUBLIC_BACKEND_URL}${content?.logo}` : "/images/logo-ft.svg"}
                alt="logo"
                width={220}
                height={60}
                style={{ width: 220, height: 60, minWidth: 220, minHeight: 60 }}
                priority // Ensures logo is loaded ASAP
              />
            </div>
            <div className="w-full mb-[10px] xl:mb-[15px]">
            ...
            <div className="w-full mb-[15px] xl:mb-[15px]">
              <div className="text-[14px] lg:text-[16px] 3xl:text-[20px] font-medium text-[#1b1b1b] flex gap-[10px] lg:gap-[15px] 3xl:gap-[20px] my-[10px] 3xl:my-[15px]">
                <Image src={"/images/icon-ft-call.svg"} alt="call" width={16} height={16} style={{ width: 16, height: 16 }} />
                <Link
              ...
              <div className="text-[14px] lg:text-[16px] 3xl:text-[20px] font-medium text-[#1b1b1b] flex gap-[10px] lg:gap-[15px] 3xl:gap-[20px] my-[10px] 3xl:my-[15px]">
                <Image src="/images/icon-ft-email.svg" alt="mail" width={16} height={16} style={{ width: 16, height: 16 }} />
                <Link
            ...
            <div className="w-full sm:mb-[15px] xl:mb-[20px]" style={{ minHeight: 70 }}>
              ...
              {/* Reserve space for newsletter form */}
          ...
          <div className="w-full lg:w-7/10 py-[10px] lg:py-0 lg:px-[20px] xl:px-[30px] 3xl:px-[35px]">
            <div className="w-full columns-2 sm:columns-5">
              {navigations?.map((item, index) => (
                <div
                  key={index}
                  className={`${
                    item.title === "Policies" && "max-sm:hidden"
                  } break-inside-avoid-column [display:table] w-full mb-3 xl:mb-6`}
                  style={{ minHeight: 120 }} // Reserve space for each navigation block
                >
                  <div className="text-footer1 mb-[10px] 2xl:mb-[20px]">{item.title}</div>
                  <div className="w-100% max-w-[80px] lg:max-w-[100px] 3xl:max-w-[120px] flex mb-[15px] 2xl:mb-[20px]">
        ...
        <div
          className="w-full bg-[#c0dbff] rounded-[20px] sm:rounded-[15px] 3xl:rounded-[20px] p-[15px] 4xs:p-[20px] xs:p-[25px_25px]
         ...
         lg:mb-[30px] xl:mb-[40px] 2xl:mb-[60px]"
          style={{ minHeight: 80 }}
        >
          <div className="w-full flex flex-wrap items-center justify-between gap-[15px]">
              ...
              {icons?.map((item, index) => (
                <div key={index}>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-[20px] h-[20px] aspect-square relative z-0 block transition-transform duration-300 hover:scale-105"
                  >
                    <Image
            ...
            <div>
              <ContactBox
                href={content?.toll_free_num ? `tel:${content?.toll_free_num}` : "tel:18004253990"}
                src={
                  content?.toll_free_icon_web
                    ? `${process.env.NEXT_PUBLIC_BACKEND_URL}${content?.toll_free_icon_web}`
        ...
        <div className="w-full pb-[15px] mb-[15px] border-b-[1px] border-solid border-black/20 flex flex-wrap sm:hidden">
          {navigations
