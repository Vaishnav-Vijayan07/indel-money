    ...
    <a href={href} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-[10px] 3xl:gap-[15px]">
      <span>
        <Image
          ...
          className="w-[15px] 4xs:w-[20px] sm:w-[20px] xl:w-[25px] 3xl:w-[30px] h-auto"
        />
      </span>
    ...
    <footer className="w-full h-auto block bg-[#e6edf7] pt-[30px] lg:pt-[40px] xl:pt-[60px] 3xl:pt-[80px] pb-[15px] lg:pb-[20px] xl:pb-[30px] 3xl:pb-[40px]">
      <div className="container min-h-[400px]">
        <div className="flex flex-wrap mx-0 lg:-mx-[20px] xl:-mx-[30px] 3xl:-mx-[35px] mb-[10px] lg:mb-[30px] xl:mb-[40px] 3xl:mb-[60px]">
          <div className="w-full lg:w-3/10 py-[10px] lg:py-0 lg:px-[20px] xl:px-[30px] 3xl:px-[35px] min-h-[300px]">
            <div className="w-full h-auto block mb-4 xl:mb-6">
              <Image
                ...
                width={360}
                height={60}
                style={{ aspectRatio: "360/60", objectFit: "contain" }}
                className="max-w-[200px] 4xs:max-w-[240px] sm:max-w-[180px] lg:max-w-[200px] xl:max-w-[220px] 3xl:max-w-[320px]"
                priority
              />
            </div>
            <div className="w-full h-auto block mb-[10px] xl:mb-[15px]">
              <div className="text-footer1 mb-[10px] 2xl:mb-[15px]">{content?.title}</div>
              <div className="text-footer2 leading-[1.3] mb-[10px] sm:mb-[15px] min-h-[50px]">
                {content?.address ? (
                  content.address
                ) : (
                  <span>
            ...
            <div className="w-full h-auto block sm:mb-[15px] xl:mb-[20px] min-h-[100px]">
            ...
            <div className="w-full h-auto columns-2 sm:columns-4">
              {navigations?.map((item, index) => (
                <div
                  ...
                  } break-inside-avoid-column [display:table] w-full h-auto mb-3 xl:mb-6 min-h-[150px]`}
                >
        ...
        <div className="w-full h-auto flex items-center justify-between">
          ...
          <div className="text-footer2 flex whitespace-nowrap gap-1">
            Designed By:
            <a href="https://www.intersmart.in/" target="_blank" rel="noopener noreferrer">
...
export async function getStaticProps() {
  // Example: Fetch footer content and icons from an API
  const content = await fetchFooterContent(); // Implement your API call
  const icons = await fetchSocialIcons(); // Implement your API call
  return {
    props: { content, icons },
  };
}
