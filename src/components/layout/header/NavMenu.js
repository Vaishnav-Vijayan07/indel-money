  ...
  return (
    <NavigationMenu>
      <NavigationMenuList>
        {/* Gold Loan Menu */}
        <NavigationMenuItem>
          <NavigationMenuTrigger>Gold Loan</NavigationMenuTrigger>
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger>Foreign Exchange</NavigationMenuTrigger>
          <NavigationMenuContent className="bg-white">
        ...
        <NavigationMenuItem>
          <Link href="/docs" legacyBehavior passHref>
            <NavigationMenuLink className={navigationMenuTriggerStyle()}>Other Loan</NavigationMenuLink>
          </Link>
        </NavigationMenuItem>
